...
public interface PyramidSolitaireModel<K> {
   ...
   *
   */
  void startGame(List<K> deck, boolean shuffle, int numRows, int numDraw) throws IllegalArgumentException;
   ...
   */
  void remove(int row1, int card1, int row2, int card2) throws IllegalArgumentException,IllegalStateException;
   ...
   * @throws IllegalStateException if the game has not yet been started
   */
  void removeUsingDraw(int drawIndex, int row, int card) throws IllegalArgumentException,IllegalStateException;
